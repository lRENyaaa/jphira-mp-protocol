...
public class PacketRegistry {
    ...
    public enum ServerBound {
        Ping(0x00, ServerBoundPingPacket.class, ServerBoundPingPacket::decode),
        ...
        LeaveRoom(0x07, ServerBoundLeaveRoomPacket.class, ServerBoundLeaveRoomPacket::decode),
        ...
        RequestStart(0x0B, ServerBoundRequestStartPacket.class, ServerBoundRequestStartPacket::decode),
        Ready(0x0C, ServerBoundReadyPacket.class, ServerBoundReadyPacket::decode),
        CancelReady(0x0D, ServerBoundCancelReadyPacket.class, ServerBoundCancelReadyPacket::decode),
        Played(0x0E, ServerBoundPlayedPacket.class, ServerBoundPlayedPacket::decode),
        Abort(0x0F, ServerBoundAbortPacket.class, ServerBoundAbortPacket::decode),;
    ...
    public enum ClientBound {
        Pong(0x00, ClientBoundPongPacket.class, ClientBoundPongPacket::decode),
