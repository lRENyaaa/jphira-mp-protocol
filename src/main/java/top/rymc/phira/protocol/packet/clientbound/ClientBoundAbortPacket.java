...
public abstract class ClientBoundAbortPacket extends ClientBoundPacket {

    @RequiredArgsConstructor
    public static class Failed extends ClientBoundAbortPacket {
    ...
    @RequiredArgsConstructor
    public static class Success extends ClientBoundAbortPacket {
