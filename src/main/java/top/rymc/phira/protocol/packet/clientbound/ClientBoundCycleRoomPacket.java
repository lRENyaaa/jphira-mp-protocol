...
public abstract class ClientBoundCycleRoomPacket extends ClientBoundPacket {

    @RequiredArgsConstructor
    public static class Failed extends ClientBoundCycleRoomPacket {
    ...
    @RequiredArgsConstructor
    public static class Success extends ClientBoundCycleRoomPacket {
